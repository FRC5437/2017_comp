...
public class Robot extends IterativeRobot {
	...
	public void robotInit() {
		...
		chooser.addObject("Left Side More Turn", new LeftGear(0.7, 55, 0.35));
		chooser.addObject("Left Side Less Speed", new LeftGear(0.7, 50, 0.2));
		chooser.addObject("Left Side More Turn Less Speed", new LeftGear(0.7, 55, 0.2));
		chooser.addObject("- - - - - - - - - - - - - - ", new DoNothing());
		chooser.addObject("Right Side", new RightGear(0.7, -50, 0.35));
		chooser.addObject("Right Side More Turn", new RightGear(0.7, -55, 0.35));
		chooser.addObject("Right Side Less Speed", new RightGear(0.7, -50, 0.2));
		chooser.addObject("Right Side More Turn Less Speed", new RightGear(0.7, -55, 0.2));
		chooser.addObject("- - - - - - - - - - - - - -  ", new DoNothing());
