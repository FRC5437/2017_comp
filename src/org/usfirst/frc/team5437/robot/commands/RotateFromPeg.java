 ...
 *
 */
public class RotateFromPeg extends PIDCommand {
    ...
    public RotateFromPeg(boolean side, double rotation) {
    	super(kP, kI, kD);
    ...
    protected void usePIDOutput(double output) {
    	if (left) {
    	Robot.chassis.PIDDrive(output * 0.6, 0.0);
    	} else {Robot.chassis.PIDDrive(0.0, -output * 0.6);}
